<div id="navBarContainer">
                <nav class="navBar">
                    ...
                    <div class="group">
                        ...
                        <div class="navItem">
                            <span onclick="openPage('index.php')" role="link" tabindex="0" class="navItemLink">Your Music</span>
                        </div>

                        <div class="navItem">
                            <span onclick="openPage('profile.php')" role="link" tabindex="0" class="navItemLink">Profile</span>
                        </div>
                    </div>
